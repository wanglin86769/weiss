...
- **No-code drag-and-drop interface** – rapidly create web operator panels without touching HTML or
  JS.
- **Fully featured editor** – Use alignment tools, grid snapping, layers management, widget
  grouping, etc via keyboard shortcuts or mouse interaction.
